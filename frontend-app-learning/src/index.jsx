...
import SubmitTab from './course-home/submit-tab';
import { TabContainer } from './tab-page';

import {
  fetchDatesTab, fetchSubmitTab, fetchOutlineTab, fetchProgressTab, fetchStaticTab,
        ...
        <NoticesProvider>
          <UserMessagesProvider>
            <Switch>
              ...
              <PageRoute
                path={[
                  '/course/:courseId/submit/:username/',
                ]}
                render={({ match }) => (
                  <TabContainer
                    tab="submit"
                    fetch={(courseId) => fetchSubmitTab(courseId, match.params.username)}
                    slice="courseHome"
                  >
                    <SubmitTab/>
                  </TabContainer>
